...
const JobInputPanel: React.FC<JobInputPanelProps> = ({
  ...
  return (
    <div className="flex flex-col gap-5 h-full">
      <div>
        <h1 className="text-xl font-bold text-white">Job Analysis</h1>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className="
            w-full bg-[#0f1117] border border-white/[0.08] rounded-lg px-3 py-2.5
      ...
      <div className="flex flex-col gap-1.5 flex-1">
        ...
        <textarea
          ...
          className="
            flex-1 min-h-[180px] w-full bg-[#0f1117] border border-white/[0.08] rounded-lg px-3 py-2.5
